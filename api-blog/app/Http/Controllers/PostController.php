...
class PostController extends Controller
{
    ...
    {
        $posts = Post::with('comentarios', 'avaliacoes', 'categorias', 'tags')->get(); //aqui carrega os posts junto com seus comentarios. e 'comentarios' é o nome do relacionamento no model Post.
